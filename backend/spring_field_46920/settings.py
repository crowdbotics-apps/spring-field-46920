"""
Django settings for spring_field_46920 project.
...
ROOT_URLCONF = 'spring_field_46920.urls'
...
WSGI_APPLICATION = 'spring_field_46920.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "spring_field_46920 API",
    "DESCRIPTION": "API documentation for spring_field_46920 App",
    "VERSION": "v1",
}
